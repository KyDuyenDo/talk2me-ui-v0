...
/**
 * Fixed React table for lesson grammar structures — independent from VocabularyTable (own
        ...
        <tbody className="divide-y divide-[#E4E8F0] dark:divide-[#334155]">
          {items.map((item, idx) => {
            ...
            return (
              ...
              >
                <td className="px-3 sm:px-4 py-3 text-[#1B1F2E] dark:text-[#E2E8F0] align-top leading-relaxed font-bold font-mono text-[11px] sm:text-xs whitespace-nowrap">
                  {item.pattern}
                </td>
                ...
                <td className="px-3 sm:px-4 py-3 align-top text-center">
                  <button
                    ...
                    title={canPlay ? 'Nghe đoạn video chứa cấu trúc này' : 'Không tìm được đúng vị trí trong video'}
